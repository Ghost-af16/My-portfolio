...
```
git clone https://github.com/pranavkay/portfolio-speedrun-template.git
cd portfolio-speedrun-template
npm install
```
...
Or open Cursor manually, click "Open Folder", and navigate to the `portfolio-speedrun-template` folder.
