...
export function Navigation({ settings }: { settings: SiteSettings }) {
  ...
  if (config.sections.gallery) navLinks.push({ label: "Gallery", href: "#gallery" });
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-2">
          <a
            ...
            className="px-5 py-2 text-xs font-bold tracking-widest uppercase border border-border-accent text-muted hover:border-accent hover:text-accent transition-colors rounded-sm"
          >
            Email Me
          </a>
          {settings.resumeUrl && (
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2 text-xs font-bold tracking-widest uppercase border border-border-accent text-muted hover:border-accent hover:text-accent transition-colors rounded-sm"
            >
              Resume <FileText className="h-3.5 w-3.5" aria-hidden="true" />
            </a>
          )}
        </div>
